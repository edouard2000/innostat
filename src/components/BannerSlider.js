...
const BannerSlider = () => {
  const slides = [
    ...
    { image: "/slider2.png", alt: "Data Visualization Solutions" },
    { image: "/slider3.png", alt: "Professional Training Programs" },
    { image: "/slider4.PNG", alt: "Business Intelligence Services" }
  ];
